...
- Real adapters must keep work isolated to all and only the job's selected repository worktree paths.
- Cancellation and collected output must remain scoped to the job ID, including when several selected repositories are used.
